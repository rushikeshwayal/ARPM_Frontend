                    ...
                    <ul className="flex flex-col space-y-2 mt-20">
                        ...
                        <li>
                            <Link
                                ...
                                className={linkStyle("/investigator/dashboard")}
                            >
                                Dashboard
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link
                                to="/researcher/home"
                                className={linkStyle("/researcher/home")}
                            >
                                Home
                            </Link>
                        </li>
                        <li>
                            <Link
                                to="/researcher/proposals"
                                className={linkStyle("/investigator/project/subjective-forms")}
                            >
                                Proposals
                            </Link>
                        </li>
